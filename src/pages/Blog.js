...
const Blog = () => {
    ...
    return (
        <div className='p-5'>
            <div data-aos="zoom-in" data-aos-mirror="true" className='   my-5 flex flex-col w-4/5 m-full p-6 mx-auto divide-y rounded-md divide-gray-700 bg-gray-800 text-white shadow-lg border-2'>
