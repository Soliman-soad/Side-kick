...
const AddServices = () => {
    ...
    return (
      ...
      <div className='h-20 bg-pink-600'></div>
        <div className='pt-16'>
        <div className='mb-10 py-8 flex flex-col w-10/12 md:w-5/12 m-full mx-auto divide-y rounded-md divide-gray-700 text-black shadow-lg border-2'>
		...
		<button type='submit' className="block w-full p-3 text-center rounded-sm  bg-green-600 text-white font-bold">Add item</button>
	</form>
    <ToastContainer/>
        </div>
        </div>
