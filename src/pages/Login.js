...
const Login = () => {
    return (
        <div className='w-full h-screen bg-blue-400 shadow-lg flex items-center '>
      <div className='flex bg-white w-8/12 mx-auto items-center rounded-md'>
      <div>
        <img className='w-full'   src='https://img.freepik.com/free-vector/computer-login-concept-illustration_114360-7962.jpg?w=740&t=st=1667924735~exp=1667925335~hmac=5cba889e31e5e4fa99cbc221893fcbe60e088712ed311248a631b1722ba37e23'/>
      </div>
	...
	<form novalidate="" action="" className="space-y-6 ng-untouched ng-pristine ng-valid">
		<div className="space-y-1 text-sm">
			<label for="username" className="block text-gray-900">Username</label>
		...
		<button className="block w-full p-3 text-center rounded-sm  bg-blue-500 text-white font-bold">Sign in</button>
	</form>
